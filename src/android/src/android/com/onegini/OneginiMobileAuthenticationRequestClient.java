...
import static com.onegini.OneginiCordovaPluginConstants.ERROR_INVALID_MOBILE_AUTHENTICATION_METHOD;
    ...
    switch (method) {
      ...
      default:
        callbackContext.sendPluginResult(new PluginResultBuilder()
            .withPluginError(ERROR_INVALID_MOBILE_AUTHENTICATION_METHOD, ERROR_CODE_INVALID_MOBILE_AUTHENTICATION_METHOD)
            .build());
        break;
    }
  }
